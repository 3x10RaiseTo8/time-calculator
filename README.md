...
This module has a function named `add_time` that takes in two required parameters and one optional parameter:
...
This application doesn't use any external Python libraries.
